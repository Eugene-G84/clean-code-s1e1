...
var createNewTaskElement = function (taskString) {
  ...
  checkBox.classList.add("item__input", "item__input--checkbox");
  editInput.type = "text";
  editInput.classList.add("item__input", "task");

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.classList.add("item__button", "item__button--edit");

  deleteButton.classList.add("item__button", "item__button--delete", "button-delete");
  deleteButtonImg.src = "./remove.svg";
  deleteButtonImg.alt = "Delete";
  deleteButtonImg.classList.add("button-delete__icon");
